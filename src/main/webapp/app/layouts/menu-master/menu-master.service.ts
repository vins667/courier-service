...
export class MenuMasterService {
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.createdDate ? moment(res.body.createdDate) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      ...
      //   createdDate: menuMaster.createdDate && menuMaster.createdDate.isValid() ? menuMaster.createdDate.toJSON() : undefined,
      // })
    }
    return res;
  }
