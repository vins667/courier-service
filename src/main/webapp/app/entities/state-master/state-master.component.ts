...
export class StateMasterComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.stateMasterService
        ...
        .subscribe(
          (res: HttpResponse<IStateMaster[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  trackId(index: number, item: IStateMaster): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInStateMasters(): void {
    this.eventSubscriber = this.eventManager.subscribe('stateMasterListModification', () => this.loadPage());
  }

  delete(stateMaster: IStateMaster): void {
    const modalRef = this.modalService.open(StateMasterDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.stateMaster = stateMaster;
  }
  ...
  protected onSuccess(data: IStateMaster[] | null, headers: HttpHeaders, page: number): void {
